...
public class YamlUtil {
    ...
    public static void removeYaml(String id, String filePath) {
        ...
        save.put("Bypass_First_List", Yaml_Map.get("Bypass_First_List"));
        save.put("Bypass_End_List", Yaml_Map.get("Bypass_End_List"));
    ...
    public static void MergerUpdateYamlFunc(Map<String, Object> newYaml){
        ...
        if (oldBypassFirstList == null){
            oldBypassFirstList = newBypassFirstList;
        }else {
        ...
        if (oldBypassEndList == null){
            oldBypassEndList = newBypassEndList;
        }else {
