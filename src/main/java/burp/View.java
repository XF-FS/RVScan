...
//        JTabbedPane tabs = new JTabbedPane();
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (e.getClickCount() == 1) {
                    ...
                    if (column == 0) {
                        ...
                        add_map.put("body", logEntry.body);
    ...
    public static class LogEntry {
        ...
        LogEntry(String id, String type,Boolean loaded, String name, String method, String url, String re, String info, String state, String body) {
            this.id = id;
            this.type = type;
            this.loaded = loaded;
            this.name = name;
