    ...
    public static Map<String, View> Get_Views() {
        ...
        for (Map<String, Object> zidian : rule_list) {
            ...
            if (views.containsKey(type)) {
                ...
                view_one.log.add(new View.LogEntry(id, type, loaded, name, method, url, re, info, state, body));
            ...
            synchronized (log) {
                ...
                for (Map<String, Object> zidian : rule_list) {
                    ...
                    if (type2.equals(type)) {
                        ...
                        String method = (String) zidian.get("method");
                        String body = (String) zidian.get("body");
                        log.add(new View.LogEntry(id, type, loaded, name, method, url, re, info, state, body));
